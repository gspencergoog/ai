...
## [Abstract](https://json-schema.org/draft/2020-12/json-schema-validation#abstract)

JSON Schema (application/schema+json) has several purposes, one of which is JSON instance validation. This document specifies a vocabulary for JSON Schema to describe the meaning of JSON documents, provide hints for user interfaces working with JSON data, and to make assertions about what a valid document must look like.

## [Note to Readers](https://json-schema.org/draft/2020-12/json-schema-validation#name-note-to-readers)
...
## [Status of This Memo](https://json-schema.org/draft/2020-12/json-schema-validation#name-status-of-this-memo)
...
## [Copyright Notice](https://json-schema.org/draft/2020-12/json-schema-validation#name-copyright-notice)

Copyright (c) 2022 IETF Trust and the persons identified as the document authors. All rights reserved.

This document is subject to BCP 78 and the IETF Trust's Legal Provisions Relating to IETF Documents ([https://trustee.ietf.org/license-info](https://trustee.ietf.org/license-info)) in effect on the date of publication of this document. Please review these documents carefully, as they describe your rights and restrictions with respect to this document. Code Components extracted from this document must include Revised BSD License text as described in Section 4.e of the Trust Legal Provisions and are provided without warranty as described in the Revised BSD License.

[▲](https://json-schema.org/draft/2020-12/json-schema-validation#)

## [Table of Contents](https://json-schema.org/draft/2020-12/json-schema-validation#name-table-of-contents)

- [1](https://json-schema.org/draft/2020-12/json-schema-validation#section-1). [Introduction](https://json-schema.org/draft/2020-12/json-schema-validation#name-introduction)
- [2](https://json-schema.org/draft/2020-12/json-schema-validation#section-2). [Conventions and Terminology](https://json-schema.org/draft/2020-12/json-schema-validation#name-conventions-and-terminology)
- [3](https://json-schema.org/draft/2020-12/json-schema-validation#section-3). [Overview](https://json-schema.org/draft/2020-12/json-schema-validation#name-overview)
- [4](https://json-schema.org/draft/2020-12/json-schema-validation#section-4). [Interoperability Considerations](https://json-schema.org/draft/2020-12/json-schema-validation#name-interoperability-considerat)

  - [4.1](https://json-schema.org/draft/2020-12/json-schema-validation#section-4.1). [Validation of String Instances](https://json-schema.org/draft/2020-12/json-schema-validation#name-validation-of-string-instan)
  - [4.2](https://json-schema.org/draft/2020-12/json-schema-validation#section-4.2). [Validation of Numeric Instances](https://json-schema.org/draft/2020-12/json-schema-validation#name-validation-of-numeric-insta)
  - [4.3](https://json-schema.org/draft/2020-12/json-schema-validation#section-4.3). [Regular Expressions](https://json-schema.org/draft/2020-12/json-schema-validation#name-regular-expressions)

- [5](https://json-schema.org/draft/2020-12/json-schema-validation#section-5). [Meta-Schema](https://json-schema.org/draft/2020-12/json-schema-validation#name-meta-schema)
- [6](https://json-schema.org/draft/2020-12/json-schema-validation#section-6). [A Vocabulary for Structural Validation](https://json-schema.org/draft/2020-12/json-schema-validation#name-a-vocabulary-for-structural)

  - [6.1](https://json-schema.org/draft/2020-12/json-schema-validation#section-6.1). [Validation Keywords for Any Instance Type](https://json-schema.org/draft/2020-12/json-schema-validation#name-validation-keywords-for-any)

    - [6.1.1](https://json-schema.org/draft/2020-12/json-schema-validation#section-6.1.1). [type](https://json-schema.org/draft/2020-12/json-schema-validation#name-type)
    - [6.1.2](https://json-schema.org/draft/2020-12/json-schema-validation#section-6.1.2). [enum](https://json-schema.org/draft/2020-12/json-schema-validation#name-enum)
    - [6.1.3](https://json-schema.org/draft/2020-12/json-schema-validation#section-6.1.3). [const](https://json-schema.org/draft/2020-12/json-schema-validation#name-const)

  - [6.2](https://json-schema.org/draft/2020-12/json-schema-validation#section-6.2). [Validation Keywords for Numeric Instances (number and integer)](https://json-schema.org/draft/2020-12/json-schema-validation#name-validation-keywords-for-num)

    - [6.2.1](https://json-schema.org/draft/2020-12/json-schema-validation#section-6.2.1). [multipleOf](https://json-schema.org/draft/2020-12/json-schema-validation#name-multipleof)
    - [6.2.2](https://json-schema.org/draft/2020-12/json-schema-validation#section-6.2.2). [maximum](https://json-schema.org/draft/2020-12/json-schema-validation#name-maximum)
    - [6.2.3](https://json-schema.org/draft/2020-12/json-schema-validation#section-6.2.3). [exclusiveMaximum](https://json-schema.org/draft/2020-12/json-schema-validation#name-exclusivemaximum)
    - [6.2.4](https://json-schema.org/draft/2020-12/json-schema-validation#section-6.2.4). [minimum](https://json-schema.org/draft/2020-12/json-schema-validation#name-minimum)
    - [6.2.5](https://json-schema.org/draft/2020-12/json-schema-validation#section-6.2.5). [exclusiveMinimum](https://json-schema.org/draft/2020-12/json-schema-validation#name-exclusiveminimum)

  - [6.3](https://json-schema.org/draft/2020-12/json-schema-validation#section-6.3). [Validation Keywords for Strings](https://json-schema.org/draft/2020-12/json-schema-validation#name-validation-keywords-for-str)

    - [6.3.1](https://json-schema.org/draft/2020-12/json-schema-validation#section-6.3.1). [maxLength](https://json-schema.org/draft/2020-12/json-schema-validation#name-maxlength)
    - [6.3.2](https://json-schema.org/draft/2020-12/json-schema-validation#section-6.3.2). [minLength](https://json-schema.org/draft/2020-12/json-schema-validation#name-minlength)
    - [6.3.3](https://json-schema.org/draft/2020-12/json-schema-validation#section-6.3.3). [pattern](https://json-schema.org/draft/2020-12/json-schema-validation#name-pattern)

  - [6.4](https://json-schema.org/draft/2020-12/json-schema-validation#section-6.4). [Validation Keywords for Arrays](https://json-schema.org/draft/2020-12/json-schema-validation#name-validation-keywords-for-arr)

    - [6.4.1](https://json-schema.org/draft/2020-12/json-schema-validation#section-6.4.1). [maxItems](https://json-schema.org/draft/2020-12/json-schema-validation#name-maxitems)
    - [6.4.2](https://json-schema.org/draft/2020-12/json-schema-validation#section-6.4.2). [minItems](https://json-schema.org/draft/2020-12/json-schema-validation#name-minitems)
    - [6.4.3](https://json-schema.org/draft/2020-12/json-schema-validation#section-6.4.3). [uniqueItems](https://json-schema.org/draft/2020-12/json-schema-validation#name-uniqueitems)
    - [6.4.4](https://json-schema.org/draft/2020-12/json-schema-validation#section-6.4.4). [maxContains](https://json-schema.org/draft/2020-12/json-schema-validation#name-maxcontains)
    - [6.4.5](https://json-schema.org/draft/2020-12/json-schema-validation#section-6.4.5). [minContains](https://json-schema.org/draft/2020-12/json-schema-validation#name-mincontains)

  - [6.5](https://json-schema.org/draft/2020-12/json-schema-validation#section-6.5). [Validation Keywords for Objects](https://json-schema.org/draft/2020-12/json-schema-validation#name-validation-keywords-for-obj)

    - [6.5.1](https://json-schema.org/draft/2020-12/json-schema-validation#section-6.5.1). [maxProperties](https://json-schema.org/draft/2020-12/json-schema-validation#name-maxproperties)
    - [6.5.2](https://json-schema.org/draft/2020-12/json-schema-validation#section-6.5.2). [minProperties](https://json-schema.org/draft/2020-12/json-schema-validation#name-minproperties)
    - [6.5.3](https://json-schema.org/draft/2020-12/json-schema-validation#section-6.5.3). [required](https://json-schema.org/draft/2020-12/json-schema-validation#name-required)
...
- [7](https://json-schema.org/draft/2020-12/json-schema-validation#section-7). [Vocabularies for Semantic Content With "format"](https://json-schema.org/draft/2020-12/json-schema-validation#name-vocabularies-for-semantic-c)

  - [7.1](https://json-schema.org/draft/2020-12/json-schema-validation#section-7.1). [Foreword](https://json-schema.org/draft/2020-12/json-schema-validation#name-foreword)
  - [7.2](https://json-schema.org/draft/2020-12/json-schema-validation#section-7.2). [Implementation Requirements](https://json-schema.org/draft/2020-12/json-schema-validation#name-implementation-requirements)

    - [7.2.1](https://json-schema.org/draft/2020-12/json-schema-validation#section-7.2.1). [Format-Annotation Vocabulary](https://json-schema.org/draft/2020-12/json-schema-validation#name-format-annotation-vocabular)
    - [7.2.2](https://json-schema.org/draft/2020-12/json-schema-validation#section-7.2.2). [Format-Assertion Vocabulary](https://json-schema.org/draft/2020-12/json-schema-validation#name-format-assertion-vocabulary)
    - [7.2.3](https://json-schema.org/draft/2020-12/json-schema-validation#section-7.2.3). [Custom format attributes](https://json-schema.org/draft/2020-12/json-schema-validation#name-custom-format-attributes)

  - [7.3](https://json-schema.org/draft/2020-12/json-schema-validation#section-7.3). [Defined Formats](https://json-schema.org/draft/2020-12/json-schema-validation#name-defined-formats)

    - [7.3.1](https://json-schema.org/draft/2020-12/json-schema-validation#section-7.3.1). [Dates, Times, and Duration](https://json-schema.org/draft/2020-12/json-schema-validation#name-dates-times-and-duration)
    - [7.3.2](https://json-schema.org/draft/2020-12/json-schema-validation#section-7.3.2). [Email Addresses](https://json-schema.org/draft/2020-12/json-schema-validation#name-email-addresses)
    - [7.3.3](https://json-schema.org/draft/2020-12/json-schema-validation#section-7.3.3). [Hostnames](https://json-schema.org/draft/2020-12/json-schema-validation#name-hostnames)
    - [7.3.4](https://json-schema.org/draft/2020-12/json-schema-validation#section-7.3.4). [IP Addresses](https://json-schema.org/draft/2020-12/json-schema-validation#name-ip-addresses)
    - [7.3.5](https://json-schema.org/draft/2020-12/json-schema-validation#section-7.3.5). [Resource Identifiers](https://json-schema.org/draft/2020-12/json-schema-validation#name-resource-identifiers)
    - [7.3.6](https://json-schema.org/draft/2020-12/json-schema-validation#section-7.3.6). [uri-template](https://json-schema.org/draft/2020-12/json-schema-validation#name-uri-template)
    - [7.3.7](https://json-schema.org/draft/2020-12/json-schema-validation#section-7.3.7). [JSON Pointers](https://json-schema.org/draft/2020-12/json-schema-validation#name-json-pointers)
    - [7.3.8](https://json-schema.org/draft/2020-12/json-schema-validation#section-7.3.8). [regex](https://json-schema.org/draft/2020-12/json-schema-validation#name-regex)

- [8](https://json-schema.org/draft/2020-12/json-schema-validation#section-8). [A Vocabulary for the Contents of String-Encoded Data](https://json-schema.org/draft/2020-12/json-schema-validation#name-a-vocabulary-for-the-conten)

  - [8.1](https://json-schema.org/draft/2020-12/json-schema-validation#section-8.1). [Foreword](https://json-schema.org/draft/2020-12/json-schema-validation#name-foreword-2)
  - [8.2](https://json-schema.org/draft/2020-12/json-schema-validation#section-8.2). [Implementation Requirements](https://json-schema.org/draft/2020-12/json-schema-validation#name-implementation-requirements-2)
  - [8.3](https://json-schema.org/draft/2020-12/json-schema-validation#section-8.3). [contentEncoding](https://json-schema.org/draft/2020-12/json-schema-validation#name-contentencoding)
  - [8.4](https://json-schema.org/draft/2020-12/json-schema-validation#section-8.4). [contentMediaType](https://json-schema.org/draft/2020-12/json-schema-validation#name-contentmediatype)
  - [8.5](https://json-schema.org/draft/2020-12/json-schema-validation#section-8.5). [contentSchema](https://json-schema.org/draft/2020-12/json-schema-validation#name-contentschema)
  - [8.6](https://json-schema.org/draft/2020-12/json-schema-validation#section-8.6). [Example](https://json-schema.org/draft/2020-12/json-schema-validation#name-example)

- [9](https://json-schema.org/draft/2020-12/json-schema-validation#section-9). [A Vocabulary for Basic Meta-Data Annotations](https://json-schema.org/draft/2020-12/json-schema-validation#name-a-vocabulary-for-basic-meta)

  - [9.1](https://json-schema.org/draft/2020-12/json-schema-validation#section-9.1). ["title" and "description"](https://json-schema.org/draft/2020-12/json-schema-validation#name-title-and-description)
  - [9.2](https://json-schema.org/draft/2020-12/json-schema-validation#section-9.2). ["default"](https://json-schema.org/draft/2020-12/json-schema-validation#name-default)
  - [9.3](https://json-schema.org/draft/2020-12/json-schema-validation#section-9.3). ["deprecated"](https://json-schema.org/draft/2020-12/json-schema-validation#name-deprecated)
  - [9.4](https://json-schema.org/draft/2020-12/json-schema-validation#section-9.4). ["readOnly" and "writeOnly"](https://json-schema.org/draft/2020-12/json-schema-validation#name-readonly-and-writeonly)
  - [9.5](https://json-schema.org/draft/2020-12/json-schema-validation#section-9.5). ["examples"](https://json-schema.org/draft/2020-12/json-schema-validation#name-examples)

- [10](https://json-schema.org/draft/2020-12/json-schema-validation#section-10). [Security Considerations](https://json-schema.org/draft/2020-12/json-schema-validation#name-security-considerations)
- [11](https://json-schema.org/draft/2020-12/json-schema-validation#section-11). [References](https://json-schema.org/draft/2020-12/json-schema-validation#name-references)

  - [11.1](https://json-schema.org/draft/2020-12/json-schema-validation#section-11.1). [Normative References](https://json-schema.org/draft/2020-12/json-schema-validation#name-normative-references)
  - [11.2](https://json-schema.org/draft/2020-12/json-schema-validation#section-11.2). [Informative References](https://json-schema.org/draft/2020-12/json-schema-validation#name-informative-references)

- [Appendix A](https://json-schema.org/draft/2020-12/json-schema-validation#appendix-A). [Keywords Moved from Validation to Core](https://json-schema.org/draft/2020-12/json-schema-validation#name-keywords-moved-from-validat)
- [Appendix B](https://json-schema.org/draft/2020-12/json-schema-validation#appendix-B). [Acknowledgments](https://json-schema.org/draft/2020-12/json-schema-validation#name-acknowledgments)
- [Appendix C](https://json-schema.org/draft/2020-12/json-schema-validation#appendix-C). [ChangeLog](https://json-schema.org/draft/2020-12/json-schema-validation#name-changelog)
- [Authors' Addresses](https://json-schema.org/draft/2020-12/json-schema-validation#name-authors-addresses)
...
This specification will use the concepts, syntax, and terminology defined by the [JSON Schema core](https://json-schema.org/draft/2020-12/json-schema-validation#json-schema) [[json-schema](https://json-schema.org/draft/2020-12/json-schema-validation#json-schema)] specification.

## [2.](https://json-schema.org/draft/2020-12/json-schema-validation#section-2)[Conventions and Terminology](https://json-schema.org/draft/2020-12/json-schema-validation#name-conventions-and-terminology)

The key words "MUST", "MUST NOT", "REQUIRED", "SHALL", "SHALL NOT", "SHOULD", "SHOULD NOT", "RECOMMENDED", "MAY", and "OPTIONAL" in this document are to be interpreted as described in [RFC 2119](https://json-schema.org/draft/2020-12/json-schema-validation#RFC2119) [[RFC2119](https://json-schema.org/draft/2020-12/json-schema-validation#RFC2119)].
...
Elements in an array value are said to be unique if no two elements of this array are [equal](https://json-schema.org/draft/2020-12/json-schema-validation#json-schema) [[json-schema](https://json-schema.org/draft/2020-12/json-schema-validation#json-schema)].
...
This specification defines a set of assertion keywords, as well as a small vocabulary of metadata keywords that can be used to annotate the JSON instance with useful information. The [Section 7](https://json-schema.org/draft/2020-12/json-schema-validation#format) keyword is intended primarily as an annotation, but can optionally be used as an assertion. The [Section 8](https://json-schema.org/draft/2020-12/json-schema-validation#content) keywords are annotations for working with documents embedded as JSON strings.
...
Keywords that use regular expressions, or constrain the instance value to be a regular expression, are subject to the interoperability considerations for regular expressions in the [JSON Schema Core](https://json-schema.org/draft/2020-12/json-schema-validation#json-schema) [[json-schema](https://json-schema.org/draft/2020-12/json-schema-validation#json-schema)] specification.
...
Use of this keyword is functionally equivalent to an ["enum"](https://json-schema.org/draft/2020-12/json-schema-validation#enum) ([Section 6.1.2](https://json-schema.org/draft/2020-12/json-schema-validation#enum)) with a single value.
...
The length of a string instance is defined as the number of its characters as defined by [RFC 8259](https://json-schema.org/draft/2020-12/json-schema-validation#RFC8259) [[RFC8259](https://json-schema.org/draft/2020-12/json-schema-validation#RFC8259)].
...
An instance array is valid against "maxContains" in two ways, depending on the form of the annotation result of an adjacent ["contains"](https://json-schema.org/draft/2020-12/json-schema-validation#json-schema) [[json-schema](https://json-schema.org/draft/2020-12/json-schema-validation#json-schema)] keyword. The first way is if the annotation result is an array and the length of that array is less than or equal to the "maxContains" value. The second way is if the annotation result is a boolean "true" and the instance array length is less than or equal to the "maxContains" value.
...
An instance array is valid against "minContains" in two ways, depending on the form of the annotation result of an adjacent ["contains"](https://json-schema.org/draft/2020-12/json-schema-validation#json-schema) [[json-schema](https://json-schema.org/draft/2020-12/json-schema-validation#json-schema)] keyword. The first way is if the annotation result is an array and the length of that array is greater than or equal to the "minContains" value. The second way is if the annotation result is a boolean "true" and the instance array length is greater than or equal to the "minContains" value.
...
The [standard core and validation meta-schema](https://json-schema.org/draft/2020-12/json-schema-validation#meta-schema) ([Section 5](https://json-schema.org/draft/2020-12/json-schema-validation#meta-schema)) includes this vocabulary in its "$vocabulary" keyword with a value of false, since by default implementations are not required to support this keyword as an assertion. Supporting the format vocabulary with a value of true is understood to greatly increase code size and in some cases execution time, and will not be appropriate for all implementations.
...
Date and time format names are derived from [RFC 3339, section 5.6](https://json-schema.org/draft/2020-12/json-schema-validation#RFC3339) [[RFC3339](https://json-schema.org/draft/2020-12/json-schema-validation#RFC3339)]. The duration format is from the ISO 8601 ABNF as given in Appendix A of RFC 3339.
...
email:
: As defined by the "Mailbox" ABNF rule in [RFC 5321, section 4.1.2](https://json-schema.org/draft/2020-12/json-schema-validation#RFC5321) [[RFC5321](https://json-schema.org/draft/2020-12/json-schema-validation#RFC5321)].
:
idn-email:
: As defined by the extended "Mailbox" ABNF rule in [RFC 6531, section 3.3](https://json-schema.org/draft/2020-12/json-schema-validation#RFC6531) [[RFC6531](https://json-schema.org/draft/2020-12/json-schema-validation#RFC6531)].
:
...
hostname:
: As defined by [RFC 1123, section 2.1](https://json-schema.org/draft/2020-12/json-schema-validation#RFC1123) [[RFC1123](https://json-schema.org/draft/2020-12/json-schema-validation#RFC1123)], including host names produced using the Punycode algorithm specified in [RFC 5891, section 4.4](https://json-schema.org/draft/2020-12/json-schema-validation#RFC5891) [[RFC5891](https://json-schema.org/draft/2020-12/json-schema-validation#RFC5891)].
:
idn-hostname:
: As defined by either RFC 1123 as for hostname, or an internationalized hostname as defined by [RFC 5890, section 2.3.2.3](https://json-schema.org/draft/2020-12/json-schema-validation#RFC5890) [[RFC5890](https://json-schema.org/draft/2020-12/json-schema-validation#RFC5890)].
:
...
ipv4:
: An IPv4 address according to the "dotted-quad" ABNF syntax as defined in [RFC 2673, section 3.2](https://json-schema.org/draft/2020-12/json-schema-validation#RFC2673) [[RFC2673](https://json-schema.org/draft/2020-12/json-schema-validation#RFC2673)].
:
ipv6:
: An IPv6 address as defined in [RFC 4291, section 2.2](https://json-schema.org/draft/2020-12/json-schema-validation#RFC4291) [[RFC4291](https://json-schema.org/draft/2020-12/json-schema-validation#RFC4291)].
:
...
uri:
: A string instance is valid against this attribute if it is a valid URI, according to [[RFC3986](https://json-schema.org/draft/2020-12/json-schema-validation#RFC3986)].
:
uri-reference:
: A string instance is valid against this attribute if it is a valid URI Reference (either a URI or a relative-reference), according to [[RFC3986](https://json-schema.org/draft/2020-12/json-schema-validation#RFC3986)].
:
iri:
: A string instance is valid against this attribute if it is a valid IRI, according to [[RFC3987](https://json-schema.org/draft/2020-12/json-schema-validation#RFC3987)].
:
iri-reference:
: A string instance is valid against this attribute if it is a valid IRI Reference (either an IRI or a relative-reference), according to [[RFC3987](https://json-schema.org/draft/2020-12/json-schema-validation#RFC3987)].
:
uuid:
: A string instance is valid against this attribute if it is a valid string representation of a UUID, according to [[RFC4122](https://json-schema.org/draft/2020-12/json-schema-validation#RFC4122)].
:
...
A string instance is valid against this attribute if it is a valid URI Template (of any level), according to [[RFC6570](https://json-schema.org/draft/2020-12/json-schema-validation#RFC6570)].
...
json-pointer:
: A string instance is valid against this attribute if it is a valid JSON string representation of a JSON Pointer, according to [RFC 6901, section 5](https://json-schema.org/draft/2020-12/json-schema-validation#RFC6901) [[RFC6901](https://json-schema.org/draft/2020-12/json-schema-validation#RFC6901)].
:
relative-json-pointer:
: A string instance is valid against this attribute if it is a valid [Relative JSON Pointer](https://json-schema.org/draft/2020-12/json-schema-validation#relative-json-pointer) [[relative-json-pointer](https://json-schema.org/draft/2020-12/json-schema-validation#relative-json-pointer)].
:
...
A regular expression, which SHOULD be valid according to the [ECMA-262](https://json-schema.org/draft/2020-12/json-schema-validation#ecma262) [[ecma262](https://json-schema.org/draft/2020-12/json-schema-validation#ecma262)] regular expression dialect.

Implementations that validate formats MUST accept at least the subset of ECMA-262 defined in the [Regular Expressions](https://json-schema.org/draft/2020-12/json-schema-validation#regexInterop) ([Section 4.3](https://json-schema.org/draft/2020-12/json-schema-validation#regexInterop)) section of this specification, and SHOULD accept all valid ECMA-262 expressions.
...
See also the [Security Considerations](https://json-schema.org/draft/2020-12/json-schema-validation#security) ([Section 10](https://json-schema.org/draft/2020-12/json-schema-validation#security)) sections for possible vulnerabilities introduced by automatically processing the instance string according to these keywords.
...
Possible values indicating base 16, 32, and 64 encodings with several variations are listed in [RFC 4648](https://json-schema.org/draft/2020-12/json-schema-validation#RFC4648) [[RFC4648](https://json-schema.org/draft/2020-12/json-schema-validation#RFC4648)]. Additionally, sections 6.7 and 6.8 of [RFC 2045](https://json-schema.org/draft/2020-12/json-schema-validation#RFC2045) [[RFC2045](https://json-schema.org/draft/2020-12/json-schema-validation#RFC2045)] provide encodings used in MIME. This keyword is derived from MIME's Content-Transfer-Encoding header, which was designed to map binary data into ASCII characters. It is not related to HTTP's Content-Encoding header, which is used to encode (e.g. compress or encrypt) the content of HTTP request and responses.
...
The value of this property MUST be a string, which MUST be a media type, as defined by [RFC 2046](https://json-schema.org/draft/2020-12/json-schema-validation#RFC2046) [[RFC2046](https://json-schema.org/draft/2020-12/json-schema-validation#RFC2046)].
...
Instances described by this schema are expected to be strings containing HTML, using whatever character set the JSON string was decoded into. Per section 8.1 of [RFC 8259](https://json-schema.org/draft/2020-12/json-schema-validation#RFC8259) [[RFC8259](https://json-schema.org/draft/2020-12/json-schema-validation#RFC8259)], outside of an entirely closed system, this MUST be UTF-8.
...
Processing a media type or encoding is subject to the security considerations of that media type or encoding. For example, the security considerations of [RFC 4329 Scripting Media Types](https://json-schema.org/draft/2020-12/json-schema-validation#RFC4329) [[RFC4329](https://json-schema.org/draft/2020-12/json-schema-validation#RFC4329)] apply when processing JavaScript or ECMAScript encoded within a JSON string.
...
Several keywords have been moved from this document into the [Core Specification](https://json-schema.org/draft/2020-12/json-schema-validation#json-schema) [[json-schema](https://json-schema.org/draft/2020-12/json-schema-validation#json-schema)] as of this draft, in some cases with re-naming or other changes. This affects the following former validation keywords:
